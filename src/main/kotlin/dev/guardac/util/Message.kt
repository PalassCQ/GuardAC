...
enum class Message(val key: String) {
    ...
    LIVE_MENU_HITS_HEADER("live-menu-hits-header"),
    LIVE_MENU_HIT("live-menu-hit"),
    LIVE_MENU_AVG("live-menu-avg"),
    LIVE_MENU_VL("live-menu-vl"),
    LIVE_MENU_LAST_HIT("live-menu-last-hit"),
    LIVE_MENU_CLICK("live-menu-click"),
